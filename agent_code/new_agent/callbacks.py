...
from functions import get_nearest_coin_position
from functions import game_state_transformer
from functions import setup_coords
...
##############################################
    ...
    if coin != None:
        ...
        actions = ["LEFT"]
        val = self.coin_states_actions[state_id + "LEFT"]

        for action in ["RIGHT", "UP", "DOWN"]:
